  ...
  <div class="main-body select-none">
    ...
    <div id="sensors" class="sensor-box">
      ...
      <div class="grid grid-cols-2 text-center" style="align-content: center;">
        ...
        <div style="margin: auto"><span class="text-2xl">LCD module</span><img alt="" class="rainbow"
                                                                               src="../assets/images/rainbow.svg"
                                                                               width="154px">
          <p class="text-sm">Liquid crystal display as another output </p><img alt="" class="img"
    ...
    <div class="px-3">
      ...
      <p class="ml-7 mt-2.5">&emsp;ใช้วัดระดับความสูงเหนือระดับน้ำทะเล อุณหภูมิ และ
        ...
        <img alt="" src="../assets/images/formula.png" class="m-2.5" width="400px">
